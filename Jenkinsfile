    ...
    withCredentials([[$class: 'UsernamePasswordMultiBinding',
        ...
        stage('Deploy') {
            sshagent(credentials: ['ec2-flask-server-ssh']) {
                ...
                sh 'ssh ubuntu@52.78.60.160 "sudo docker run --name docker-flask -v /home/ubuntu/static:/app/static --env-file .env -e TZ=Asia/Seoul -p 80:80 -d -t \${DOCKER_USER_ID}/flask-server:\${BUILD_NUMBER}"'
            }
        }
