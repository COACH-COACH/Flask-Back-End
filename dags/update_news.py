...
fetch_and_process_news_task = PythonOperator(
    task_id='fetch_and_process_news',
    python_callable=policy_news_etl,
    dag=dag,
)

delete_old_news_task = PythonOperator(
    task_id='delete_old_news',
    python_callable=delete_old_news,
    dag=dag,
)

# 작업 흐름 정의
delete_old_news_task >> fetch_and_process_news_task

# DAG 정의 끝

# 뉴스 필터링을 위한 목표, 생애주기 유의어
life_cycle = {
